...
const MESSAGE = {
	...
	en: {
		...
		invalidImageType: images => `Invalid image type: only [${images}]`,
		...
		couldNotAddLike: error => `Could not add like: ${error.message}`,
		postNotFound: 'Post not found',
		userAlreadyLiked: 'User already liked post',
		failedToAddLike: error => `Failed to add like: ${error.message}`,
		failedToIncrementField: 'Failed to increment field',
		commentNotFound: 'Comment not found',
		alreadyLikedComment: 'Comment already liked',


		// Website
		commentCreationSuccess: 'Comment created successfully',
		reading: 'Reading',
		reposting: 'Reposting',
		sharing: 'Sharing',
		saving: 'Saving',
	...
	nl: {
		...
		amountsMustBeNonNegativeIntegers: 'Bedragen moeten positieve gehele getallen zijn',
		...
		invalidImageType: images => `Ongeldig afbeeldingstype alleen [${images}]`,
		...
		postLiked: 'Bericht geliked',
		couldNotAddLike: error => `Like kon niet worden toegevoegd: ${error.message}`,
		postNotFound: 'Bericht niet gevonden',
		userAlreadyLiked: 'Gebruiker heeft bericht al geliked',
		failedToAddLike: error => `Like kon niet worden toegevoegd: ${error.message}`,
		failedToIncrementField: 'Veld kon niet worden verhoogd',
		alreadyLikedComment: 'Reactie is al geliked',
		commentNotFound: 'Reactie niet gevonden',

		// Website
		commentCreationSuccess: 'Reactie succesvol aangemaakt',
		reading: 'Lezen',
		reposting: 'Herplaatsen',
		sharing: 'Delen',
		saving: 'Opslaan',
		shared: 'Heeft het volgende gedeeld',
		followingPosts: 'Volgende berichten',
		suggestedPeople: 'Voorgestelde mensen',
		role: 'Rol',
		age: 'Leeftijd',
		profession: 'Beroep',
	...
	// 	invalidImageType: images => `Ungültiger Bildtyp: nur [${images}]`,
